...
class CoNLLFormatter:
    ...
    def label_token(self, token):
        ...
        # Check for product
            ...
            'ቱታ', 'ጡጦ', 'ብረት', 'ውሀ', 'ዘይት', 'ቅባት', 'ብርጭቆወች',
            'መጠጫ', 'ስትሮ', 'መጠጫ', 'ውሀ', 'እሳት', 'ካቢኔት', 'ቅባት', 
            'ዘይት', 'ግርግዳ', 'ሞል', 'ኦቭን', 'ፍሪጆች', 'ማጠቢያ', 'ላውንደሪዎች',
            'ምድጃዎችን', 'ጎማዎች', 'ጎማ', 'ምድጃዎችን', 'ፎቅ', 'ሱቅ', 'የቴሌግራም',
            'በኤሌክትሪክ', 'ሲልከን', 'በሴራሚክ', 'ቢላዎች', 'መጋዝ', 'ቢላ', 'መቀስ',
            'መክተፊያ', 
